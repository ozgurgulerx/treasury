...
|-----------|-------------|
| Portfolio Optimization (Mean-Variance) | Investment allocation |
| Reinforcement Learning | Dynamic rebalancing strategies |
| Credit Scoring Models | Counterparty risk assessment |
| Constraint Optimization | Policy compliance checking |
| Scenario Simulation | Funding strategy testing |

## Expected Benefits

- **Improved yield** on surplus cash within risk parameters
- **Lower funding costs** through optimized debt mix
- **Automated compliance** with investment policies
- **Proactive facility management** avoiding covenant breaches
